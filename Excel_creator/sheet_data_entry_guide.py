...
def add_guide_sheet(workbook):
    ...
    css = [
        ...
        ['Material ratio 1', 'Relative ratio for material 1 (only if multiple materials are used)', 'Number', '', '3'],
        ['Material ratio 2', 'Relative ratio for material 2 (only if multiple materials are used)', 'Number', '', '1'],
        ['Material ratio 3', 'Relative ratio for material 3 (only if multiple materials are used)', 'Number', '', '2'],
